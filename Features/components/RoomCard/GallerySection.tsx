...
export default function GallerySection() {
  ...
  return (
    <>
      <section className="w-full mx-auto max-w-[1320px] max-h-[423px] h-full flex gap-6 relative">
        ...
        <Button
          ...
          border="orange"
          className="absolute bottom-4 left-4 max-w-[133px] w-full h-5 gap-1 text-[10px] bg-secondary"
        >
          <ImagePlus size={14} /> مشاهده تصاویر بیشتر
        </Button>
      </section>
      <Dialog
        open={open}
        ...
        maxWidth={false}
        PaperProps={{
          sx: { width: "980px", height: "560px", borderRadius: "16px" },
        }}
      >
        <IconButton
            ...
            <div className="flex flex-col justify-between">
              {galleryImages.slice(0, 4).map((src) => (
                <div
                  ...
                  className=" relative w-40 h-[120px] rounded-lg overflow-hidden cursor-pointer hover:scale-[1.03] transition "
                >
